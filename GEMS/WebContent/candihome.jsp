...
<body>
	...
	<% if(verify.equals("1"))
		{
	%> 
	<div class="addevent"><a href="addeventsfront.jsp"><input type ="submit" value ="Add Event" class ="methods"></a></div>
	...
	<div class="details"><a href="detailsfront.jsp"><input type ="submit" value ="Enter/modify Details" class="methods"></a></div>
