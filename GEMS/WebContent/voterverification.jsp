...
<%
	...
	if(rs.next())
	{
		booth = booth + rs.getString("booth");
		at = rs.getInt("slot");
		till = at+1;
	}
	else
	...
	String xt = Integer.toString(at);
	String yt = Integer.toString(till);
	Random rand = new Random();
	int OTP = rand.nextInt(9999);
	session.setAttribute("otp",OTP);
	final String to = "authoritygems@gmail.com";
    final String subject = "OTP Confirmation";
    final String messg = "Booth number is "+booth+" and the slot is from "+xt+" HRS to "+yt+ " HRS. OTP for Slot and Booth verification is "+OTP;
    final String from = "gemsiitkgp@gmail.com";
    final String pass = "********"; //Enter password
...
%>
	...
	<div class ="login">
        <h1 style="text-align:center">Enter OTP given by election authorities</h1><br/>
        <h2 style="text-align:center">To confirm your slot and booth number</h2>
        <div class="eventform">
        
            <form id ="changepassword" class="eventinput-group" action="validate2.jsp" autocomplete="off" method="post">            
